...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')] # Sizning original statik fayllaringiz
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # Collectstatic fayllarni yig'adigan joy
